...
exports.ApplicationCommandConstructor = exports.ApplicationCommandManager = void 0;
const discord_js_1 = require("discord.js");
const js_augmentations_1 = require("js-augmentations");
const util_js_1 = require("../util/util.js");
const events_1 = require("events");
class ApplicationCommandManager extends events_1.EventEmitter {
    constructor() {
        super();
    }
}
exports.ApplicationCommandManager = ApplicationCommandManager;
class ApplicationCommandManagerOld {
    constructor(client) {
        this.client = client;
        this.client = client;
...
exports.default = ApplicationCommandManagerOld;
